...
## Based on the PdmV outline at https://its.cern.ch/jira/browse/PDMVMCPROD-71
...
if [ "$#" -ne 4 ]; then
    ...
    echo "Usage: ./genFromGridpack_2022EE.sh gridpack nevents ctau nThreads"
    exit 1
fi
...
cmsDriver.py Configuration/GenProduction/python/${HADRONIZER}  \
    ...
    --conditions ${conditions} --beamspot Realistic25ns13p6TeVEarly2022Collision \
...
cmsDriver.py  \
   ...
   --step DIGI,DATAMIX,L1,DIGI2RAW,HLT:2022v14 --procModifiers premix_stage2,siPixelQualityRawToDigi --datamix PreMix \
