...
## This script is used to produce MINI-AOD files from a gridpack for 2023BPix samples.
## NOT YET TESTED
## Based on the PdmV outline at https://its.cern.ch/jira/browse/PDMVMCPROD-92
