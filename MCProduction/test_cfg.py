...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:iDMe_Mchi-10p5_dMchi-1p0_mZDinput-30p0_ctau-0_1jet_icckw1_drjj0_xptj80_xqcut20_slc7_amd64_gcc11_CMSSW_13_0_13_tarball_1639761_PremixRECO_ctau-10_year-2022.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:MINIoutput.root'),
...
process.MINIAODSIMoutput.outputCommands = cms.untracked.vstring([line for line in process.MINIAODSIMoutput.outputCommands if "slimmedCaloJets" not in line and "oniaPhotonCandidates" not in line and "offlineSlimmedPrimaryVerticesWithBS" not in line and "primaryVertexWithBSAssociation" not in line and "slimmedHcalRecHits" not in line])
