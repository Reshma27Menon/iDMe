...
mkdir RecoEgamma
cp -r /uscms/home/sbrightt/nobackup/iDM/iDMe_analysis/CMSSW_10_6_26/src/RecoEgamma/EgammaTools ./RecoEgamma/
...
cd $HEAD
tar -czf ntuplizer_CMSSW_10_6_26_noCustomMini.tar.gz CMSSW_10_6_26/
xrdcp -f ntuplizer_CMSSW_10_6_26_noCustomMini.tar.gz root://cmseos.fnal.gov//store/group/lpcmetx/iDMe//compiled_CMSSW_envs/