...
def fillHistos(events,h,samp,cut,info,sum_wgt=1):
    ...
    if info["type"] == "signal":
        ...
        fake_pf = ak.flatten(events.Electron[~events.Electron.genMatched & ~events.Electron.hasLptMatch])
        fake_both = ak.flatten(events.Electron[~events.Electron.genMatched & events.Electron.hasLptMatch])
        fake_lpt = ak.flatten(events.LptElectron[~events.LptElectron.genMatched & ~events.LptElectron.gedIsMatched])

        fake_pf_passID = ak.values_astype(fake_pf.passID,int)
        fake_both_passID = ak.values_astype(fake_both.passID,int)
...
>>>>>>> kyungmin/main
        ...
        h.fill("match_ele_dxySignif",match_type='Both',passID=match_both_passID,signif=match_both.dxy/match_both.dxyErr,weight=1)
        h.fill("match_ele_trkChi2",match_type='Both',passID=match_both_passID,chi2=match_both.trkChi2,weight=1)
        h.fill("match_ele_trkProb",match_type='Both',passID=match_both_passID,prob=match_both.trkProb)
        h.fill("match_ele_trkRelIso",match_type='Both',passID=match_both_passID,iso=match_both.trkRelIso,weight=1)
        h.fill("match_ele_calRelIso",match_type='Both',passID=match_both_passID,iso=match_both.calRelIso,weight=1)
        h.fill("match_ele_PFRelIso",match_type='Both',passID=match_both_passID,iso=match_both.PFRelIso,weight=1)
        h.fill("match_ele_miniRelIso",match_type='Both',passID=match_both_passID,iso=match_both.miniRelIso,weight=1)
        h.fill("match_ele_mindRJets",match_type='Both',passID=match_both_passID,dR=match_both.mindRj,weight=1)
        h.fill("match_ele_mindPhiJets",match_type='Both',passID=match_both_passID,phi=match_both.mindPhiJ,weight=1)
        h.fill('match_ele_isPF',match_type='Both',passID=match_both_passID,isPF=ak.values_astype(match_both.isPF,int),weight=1)
        h.fill('match_ele_numTrkHits',match_type='Both',passID=match_both_passID,numHits=match_both.numTrackerHits,weight=1)
        h.fill('match_ele_numPixHits',match_type='Both',passID=match_both_passID,numHits=match_both.numPixHits,weight=1)
        h.fill('match_ele_numStripHits',match_type='Both',passID=match_both_passID,numHits=match_both.numStripHits,weight=1)
        h.fill("match_ele_sigmaIetaIeta",match_type='Both',passID=match_both_passID,sieie=match_both.full55sigmaIetaIeta,weight=1)
        h.fill("match_ele_absdEtaSeed",match_type='Both',passID=match_both_passID,detaSeed=match_both.absdEtaSeed,weight=1)
        h.fill("match_ele_absdPhiIn",match_type='Both',passID=match_both_passID,phi=match_both.absdPhiIn,weight=1)
        h.fill("match_ele_HOverE",match_type='Both',passID=match_both_passID,hoe=match_both.HoverE,weight=1)
        h.fill("match_ele_1E1p",match_type='Both',passID=match_both_passID,emp=match_both.abs1overEm1overP,weight=1)
        h.fill("match_ele_expMissing",match_type='Both',passID=match_both_passID,missing=match_both.expMissingInnerHits,weight=1)
...
>>>>>>> kyungmin/main
        ...
        h.fill("match_ele_gen_pt_vs_vxy1",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_pt_vs_vxy10",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_pt_vs_vxy100",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_pt_vs_dR",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,dR=genObj_both.dr,weight=1)
        h.fill("match_ele_gen_dR_vs_vxy1",match_type='Both',passID=match_both_passID,dR=genObj_both.dr,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_dR_vs_vxy10",match_type='Both',passID=match_both_passID,dR=genObj_both.dr,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_dR_vs_vxy100",match_type='Both',passID=match_both_passID,dR=genObj_both.dr,vxy=genObj_both.vxy,weight=1)
        h.fill("match_ele_gen_eta",match_type='Both',passID=match_both_passID,eta=genObj_both.eta,weight=1)
        h.fill("match_ele_gen_phi",match_type='Both',passID=match_both_passID,phi=genObj_both.phi,weight=1)
        h.fill("match_ele_gen_dR",match_type='Both',passID=match_both_passID,dR=genObj_both.dr,weight=1)
        h.fill("match_ele_ptRes",match_type='Both',passID=match_both_passID,ptres=(genObj_both.pt-match_both.pt)/genObj_both.pt,weight=1)
        h.fill("match_ele_gen_pt_vs_vxy1_dRBinned",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,weight=1)
        h.fill("match_ele_gen_pt_vs_vxy10_dRBinned",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,weight=1)
        h.fill("match_ele_gen_pt_vs_vxy100_dRBinned",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,vxy=genObj_both.vxy,dRCat=genObj_both.dRbin,weight=1)
        h.fill("match_ele_gen_pt_vs_dR_vxyBinned",match_type='Both',passID=match_both_passID,pt=genObj_both.pt,dR=genObj_both.dr,vxyCat=genObj_both.vxyBin,weight=1)
        h.fill("match_ele_gen_dR_vs_vxy1_ptBinned",match_type='Both',passID=match_both_passID,dR=genObj_both.dr,vxy=genObj_both.vxy,ptCat=genObj_both.ptBin,weight=1)
...
>>>>>>> kyungmin/main
        ...
        h.fill("fake_ele_pt",ele_type='Both',passID=fake_both_passID,pt=fake_both.pt,weight=1)
        h.fill("fake_ele_eta",ele_type='Both',passID=fake_both_passID,eta=fake_both.eta,weight=1)
        h.fill("fake_ele_phi",ele_type='Both',passID=fake_both_passID,phi=fake_both.phi,weight=1)
        h.fill("fake_ele_dxy",ele_type='Both',passID=fake_both_passID,dxy=fake_both.dxy,weight=1)
        h.fill("fake_ele_dxySignif",ele_type='Both',passID=fake_both_passID,signif=fake_both.dxy/fake_both.dxyErr,weight=1)
        h.fill("fake_ele_trkChi2",ele_type='Both',passID=fake_both_passID,chi2=fake_both.trkChi2,weight=1)
        h.fill("fake_ele_trkProb",ele_type='Both',passID=fake_both_passID,prob=fake_both.trkProb)
        h.fill("fake_ele_trkRelIso",ele_type='Both',passID=fake_both_passID,iso=fake_both.trkRelIso,weight=1)
        h.fill("fake_ele_calRelIso",ele_type='Both',passID=fake_both_passID,iso=fake_both.calRelIso,weight=1)
        h.fill("fake_ele_PFRelIso",ele_type='Both',passID=fake_both_passID,iso=fake_both.PFRelIso,weight=1)
        h.fill("fake_ele_miniRelIso",ele_type='Both',passID=fake_both_passID,iso=fake_both.miniRelIso,weight=1)
        h.fill("fake_ele_mindRJets",ele_type='Both',passID=fake_both_passID,dR=fake_both.mindRj,weight=1)
        h.fill("fake_ele_mindPhiJets",ele_type='Both',passID=fake_both_passID,phi=fake_both.mindPhiJ,weight=1)
        h.fill('fake_ele_isPF',ele_type='Both',passID=fake_both_passID,isPF=ak.values_astype(fake_both.isPF,int),weight=1)
        h.fill('fake_ele_numTrkHits',ele_type='Both',passID=fake_both_passID,numHits=fake_both.numTrackerHits,weight=1)
        h.fill('fake_ele_numPixHits',ele_type='Both',passID=fake_both_passID,numHits=fake_both.numPixHits,weight=1)
        h.fill('fake_ele_numStripHits',ele_type='Both',passID=fake_both_passID,numHits=fake_both.numStripHits,weight=1)
        h.fill("fake_ele_sigmaIetaIeta",ele_type='Both',passID=fake_both_passID,sieie=fake_both.full55sigmaIetaIeta,weight=1)
        h.fill("fake_ele_absdEtaSeed",ele_type='Both',passID=fake_both_passID,detaSeed=fake_both.absdEtaSeed,weight=1)
        h.fill("fake_ele_absdPhiIn",ele_type='Both',passID=fake_both_passID,phi=fake_both.absdPhiIn,weight=1)
        h.fill("fake_ele_HOverE",ele_type='Both',passID=fake_both_passID,hoe=fake_both.HoverE,weight=1)
        h.fill("fake_ele_1E1p",ele_type='Both',passID=fake_both_passID,emp=fake_both.abs1overEm1overP,weight=1)
        h.fill("fake_ele_expMissing",ele_type='Both',passID=fake_both_passID,missing=fake_both.expMissingInnerHits,weight=1)
        h.fill("fake_ele_passConvVeto",ele_type='Both',passID=fake_both_passID,passVeto=fake_both.conversionVeto,weight=1)
        h.fill("fake_ele_IDscore",ele_type='Both',passID=fake_both_passID,id=fake_both.IDscore,weight=1)
